...
# API IP Label
api_label = tk.Label(frame, text='Connect API IP')
api_label.pack()
# API IP Input Label
api_input = tk.Text(frame,
                height=1,
                width=20)
api_input.pack()
...
input_label_1 = tk.Label(frame, text='Username')
input_label_1.pack()
# Username Input Creation
input_number_1 = tk.Text(frame,
                   height = 1,
                   width = 20)
input_number_1.pack()
# may not work; dev to insert text because laziness is a bitch
...
# may not work; dev to insert text because laziness is a bitch
# Label2 Creation
input_label_2 = tk.Label(frame, text='Password')
input_label_2.pack()

# TextBox2 Creation
input_number_2 = tk.Text(frame,
                    height=1,
                    width=20)
input_number_2.pack()
# may not work; dev to insert text because laziness is a bitch
...
input_label_3 = tk.Label(frame, text='Password 2.0 ;)')
input_label_3.pack()
...
# Button Creation
get_token_button = tk.Button(frame,
                        text='Get Token', 
                        command=getToken)
get_token_button.pack()
# Expiration Label Creation
expiration_label = tk.Label(frame, text='Expiration', width=20, height=1, justify='center')
expiration_label.pack()
# Expiration Creation
expiration = tk.Label(frame, text='', width=20, justify='center')
expiration.pack()
# Token Label Creation
# background='black',
# token_label = tk.Label(frame, text='Token', width=20, height=1, justify='center', border=10, borderwidth=0, activebackground='gray', padx=10, pady=10)
# token_label.pack()
# Token Creation
# token_txt = tk.Label(frame, text='', width=20, height=20, justify='center', wraplength=200)
# token_txt.pack()
# ScrolledTextBoxLabel
scrolled_text_box_label = tk.Label(frame, text='Token (Beta Scroll)', width=10, height=1, justify='center', padx=20, pady=20)
...
# SaveConfigButton
save_config_button = tk.Button(frame,
                            text='Save Configuration',
                            command=saveConfig)
save_config_button.pack()
save_success_status_msg = tk.Label(frame, text='', width=20, justify='center')                        
# save_success_status_msg.pack()

# CloseWindowRelaunchButton
close_window_relaunch_button = tk.Button(frame,
                                    text='Close & Relaunch',

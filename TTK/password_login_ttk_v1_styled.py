...
# applying styles
label_style = Style()
label_style.configure('BG.TLabel', foreground='gray', background='black')
button_style = Style()
button_style.configure('BG.TButton', foreground='gray', background='black')
...
# API IP Label
api_label = Label(frame, text='Connect API IP', style='BG.TLabel')
api_label.pack()
# API IP Input Label
...
input_label_1 = Label(frame, text='Username', style='BG.TLabel')
input_label_1.pack()
...
# may not work; dev to insert text because laziness is a bitch
# Label2 Creation
input_label_2 = Label(frame, text='Password', style='BG.TLabel')
input_label_2.pack()
...
input_label_3 = Label(frame, text='Password 2.0 ;)', style='BG.TLabel')
input_label_3.pack()
...
expiration_label = Label(frame, text='Expiration', width=20, style='BG.TLabel')
expiration_label.pack()
# Expiration Creation
expiration = Label(frame, text='', width=20, style='BG.TLabel')
expiration.pack()
...
scrolled_text_box_label = Label(frame, text='Token (Beta Scroll)', width=10, style='BG.TLabel')
...
save_success_status_msg = Label(frame, text='', width=20, style='BG.TLabel')                        
# save_success_status_msg.pack()

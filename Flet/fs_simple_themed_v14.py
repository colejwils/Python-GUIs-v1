...
def main(page: ft.Page):
    ...
    def build_clients_view():
        ...
        # This is our stub test function that we'll call
        ...
        def build_client_section(idx, c):
            ...
            # NEW: "Test" button for each client
            ...
            return ft.Column(
                [
                    ...
                    secret_tf,
                    ft.Row([test_btn]),  # place test button in a row
                    ft.Divider()
                ],
                spacing=10
            )
    ...
    def build_vms_view():
        ...
        # NEW: Stub test function for an entire VM config
        ...
        def build_vm_section(idx, vm):
            ...
            # NEW: "Test" button for the entire VM config
            test_vm_btn = ft.ElevatedButton(
                "Test VM",
                color="white",
                bgcolor="#00ADEF",

...
def main(page: ft.Page):
        ...
        return ft.View(
            ...
            controls=[
                ft.Text(
                    ...
                    # No color here, let theme handle text color
                ),
                ...
                ft.ElevatedButton(
                    ...
                    # Remove explicit text color => uses on_primary from theme
                    # color="white",
                    # background => uses primary from theme? Let's set it explicitly for clarity:
                    bgcolor="#00ADEF",
                ),
            ],
        )
    ...
    def build_tests_view():
        welcome_text = ft.Text(
            ...
            # No color => use theme's on_background
        )
        ...
        for t in tests:
            test_buttons.append(
                ft.ElevatedButton(
                    ...
                    # color => let theme handle text color on primary
                    bgcolor="#00ADEF",  # teal
                )
            )
                        ...
                        ft.Row(
                            [
                                ft.IconButton(
                                    ...
                                    tooltip="Settings",
                                    # No color => theme handles icon color (on_surface)
                                    on_click=settings_click
                                ),
                                ft.IconButton(
                                    icon=ft.Icons.LOGOUT,
                                    tooltip="Logout",
                                    # No color => theme handles icon color
                ...
                ft.Row(
                    [
                        ft.Text(
                            ...
                            size=24,
                            weight=ft.FontWeight.W_600,
                            # No color => theme's on_background
                        ),
                        ft.IconButton(
                            icon=ft.Icons.ARROW_BACK,
                            tooltip="Back",
                            on_click=go_back
                            # No color => use theme for icon
                        )
                    ],
                    alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                ),

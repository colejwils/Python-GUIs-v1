...
def main(page: ft.Page):
    ...
    def build_tests_view():
        # Insert the Forescout logo (retrieved from the public site)
        forescout_logo = ft.Image(
            # src="https://www.forescout.com/wp-content/uploads/2023/02/Forescout-logo.png",
            # src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRirlWVhPRMsxN4oG1MrcFUtEiKc2LIu2K_7A&s',
            # src='https://cdn.brandfetch.io/cysiv.com/fallback/lettermark/theme/dark/h/256/w/256/icon?c=1bfwsmEH20zzEfSNTed',

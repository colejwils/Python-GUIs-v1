...
def main(page: ft.Page):
    ...
    page.bgcolor = "white"                # Light background (overridden in dark mode automatically)
    ...
    def build_test_config_view(test_id: str):
        ...
        return ft.View(
            ...
            [
                ...
                ft.Divider(),
                ft.Text("Please configure the test details below:", size=16, color="black"),
                test_username_tf,
                test_password_tf,
                eap_dropdown,
                ft.ElevatedButton(
    ...
    def build_settings_view():
        # We'll use a Switch to toggle dark mode on/off.
        # If page.theme_mode == DARK, switch is True, else False.
        ...
        return ft.View(
            ...
            [
                ft.Row(
                    [
                        ft.Text("Settings", size=24, weight=ft.FontWeight.W_600, color="black"),
                        ft.IconButton(
                            icon=ft.Icons.ARROW_BACK,
                            tooltip="Back",
                            icon_color="black",
                ...
                ft.Column(
                    [
                        ft.Text("Theme Options", color="black"),
                        dark_mode_switch,
                    ],
                    spacing=10,
    ...
    def toggle_dark_mode(e: ft.ControlEvent):
        # e.control.value is True if switch is On
        if e.control.value:
            # Turn on dark mode
            page.theme_mode = ft.ThemeMode.DARK
            # If you want the background to become black immediately:
            page.bgcolor = "black"
        else:
            # Turn off dark mode (light)

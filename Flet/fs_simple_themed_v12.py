...
def main(page: ft.Page):
    ...
    # ─────────────────────────────────────────────────────────
    # 5. VMS VIEW (SSH for wpa_supplicant & eapol_test)
    # ─────────────────────────────────────────────────────────
    def build_vms_view():
        def update_vms_list():
    ...
    def build_settings_view():
        ...
        # NEW: "Persistent Configuration" switch
    ...
    # NEW: Toggle persistent configuration
    def toggle_persistent_config(e: ft.ControlEvent):
        ...
        # In a real app, you could save to a file or DB here if new_val is True
        # or remove the config file if new_val is False, etc.
